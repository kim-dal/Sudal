		...
		while ($row = mysql_fetch_array($result))
		{
            ...
            if($table=='board'){
                ...
                if($row[file_copied_0]){
                    $concertimg='sub/php/data/'.$row[file_copied_0];
                }else{
                    $concertimg= 'sub/php/data/default.jpg';
                }
            }
           ...
           if($table=='greet'){ 
			...
			echo "      
				<div class='col1'><a href='sub/13_view.php?table=$table&num=$num'>$subject</a></div> <div class='col2'>$regist_day</div>
				<div class='clear'></div>
			";
             ...
             echo "      
				<div class='col1'><a href='sub/13_view.php?table=$table&num=$num'>
